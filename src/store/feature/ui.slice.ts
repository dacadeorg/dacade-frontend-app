 ...
 */
export const toggleBodyScrolling =
  (lock: boolean) => (dispatch: any) => {
    ...
    const scrollTop = parseInt(
      (body.style.top.match(/(\d+)/) || [0])[0] as string
    );
 ...
 */
export const toggleShowReferralPopup =
  (show: boolean) => (dispatch: any) => {
