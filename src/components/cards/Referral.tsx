...
export default function Referral({ referral }: ReferralProps): ReactElement {
  ...
  return (
    <div className="cursor-pointer flex md:flex-row-reverse md:space-x-5 px-5 min-h-32 md:h-auto md:w-full justify-between hover:bg-tertiary relative" onClick={openLink}>
      <div className="bg-theme-accent flex-col w-full h-full justify-between md:-space-y-1 pl-3 pr-5 mt-7 mb-5">
        ...
        <div className="inline-flex md:flex h-2/3 md:flex-row flex-col-reverse justify-between">
          <div className="text-sm pt-8 md:pt-2 md:pb-4 text-secondary">{t("bounties.reward.referral")}</div>
          <div>
