...
const Challenge: React.FC<ChallengeProps> = ({}) => {
  ...
  return (
    <div
    className="border-solid border border-gray-200 bg-gray-50 rounded-3xl mb-5 group text-gray-700"
  >
    <div
      className="border-solid border-b border-gray-300 bg-white rounded-3xl sm:p-8 sm:pb-6 w-full p-6"
    >
      <div className="w-full">
        <div className="lg:flex mb-1">
          <div className="lg:pr-20 w-full lg:w-3/5">
            <div className="text-lg text-gray-900 font-medium leading-normal">
              Build a Celo dApp
            </div>
            ...
            <div
          className="md:hidden text-xxs px-2.5 py-0.5 bg-gray-200 text-gray-500 rounded-3xl max-w-max tracking-wider mb-6.5 uppercase font-medium"
        >
          Beginner
        </div>
          </div>
          ...
          <div
            className="flex flex-col mb-6 lg:mb-0 mt-6 md:mt-0 rounded-full max-w-max text-sm"
          >
            <div className="flex items-center mb-8">
              <Coin size="medium" token="NFT" />
      ...
      <div
        className="divide-y-2 divide-gray-200 divide-dotted flex flex-col"
      >
        <div
          className="hidden lg:block text-xxs px-2.5 py-0.5 bg-gray-200 text-gray-500 rounded-3xl max-w-max tracking-wider mb-6.5 uppercase font-medium"
        >
          Beginner
        </div>
    ...
    <div className="sm:px-8 sm:pt-6 sm:pb-9 w-full p-6 rounded-3xl text-sm">
      <div className="mb-3 text-gray-400 font-semibold uppercase text-xxs">
        related content
      </div>
      <div className="lg:w-10/12 pb-6.5 text-gray-500 font-normal text-sm">
        <div className="mb-1.5 font-medium leading-normal">
