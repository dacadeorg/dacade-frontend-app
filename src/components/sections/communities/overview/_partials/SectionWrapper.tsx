...
export function SectionWrapper({ title, description, children }: SectionWrapperProps): ReactElement {
  return (
    <div className="py-12 flex flex-col lg:flex-row">
      ...
      <div className="w-full mt-5 lg:m-0 lg:w-9/12 xl:w-3/5 items-center flex flex-col">{children}</div>
    </div>
  );
}
