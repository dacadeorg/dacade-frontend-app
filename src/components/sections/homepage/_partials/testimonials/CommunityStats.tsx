...
export default function CommunityStats() {
  ...
  return (
    <div className="p-7 bg-brand rounded-3.5xl mx-auto text-invert relative md:absolute md:top-28 lg:top-32 xl:w-1/3 md:w-4/6 z-10 sm:max-w-sm">
      ...
      <div className="relative divide-y divide-white divide-dotted">
        {formattedStat.map((stat) => (
          <div key={stat.title} className="py-6">
            <span className="block lg:text-.5xl text-xl mb-2 tracking-3">{stat.count}</span>
