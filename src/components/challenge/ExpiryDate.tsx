...
export default function ExpiryDate({ expiresAt }: { expiresAt?: string }): ReactElement {
  ...
  return (
    <div className="bg-secondary py-8 px-3 border rounded border-solid border-primary flex items-center justify-start md:justify-center">
      <p className="text-primary flex flex-col md:flex-row mx-auto items-center gap-1 text-sm">
