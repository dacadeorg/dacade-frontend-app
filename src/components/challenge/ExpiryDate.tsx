...
export default function ExpiryDate({ expiresAt }: { expiresAt?: string }): ReactElement {
  ...
  return (
    <div data-testid="expiryDateId" className="bg-gray-50 py-6 px-3 md:py-9 md:px-3 border rounded border-solid border-gray-200 flex items-center justify-start md:justify-center">
