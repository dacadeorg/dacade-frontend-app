...
export default function Button({
  ...
  const componentClassName: string = classNames(
    ...
    {
      "disabled:bg-tertiary disabled:text-tertiary": variant === "primary" || variant === "secondary",
      "disabled:border-gray-400 disabled:text-tertiary disabled:bg-transparent": variant.includes("outline"),
      "bg-brand hover:bg-brand-dark text-white": variant === "primary",
      "bg-tertiary": variant === "secondary",
      "text-brand border border-solid border-brand bg-transparent hover:bg-brand-dark hover:text-white": variant === "outline-primary",
      "text-gray-100 border border-solid border-gray-100 bg-transparent hover:bg-tertiary hover:text-gray-900": variant === "outline-secondary",
      "text-white border border-solid border-white bg-transparent hover:bg-white hover:text-brand": variant === "outline-white",
      "text-tertiary border border-solid border-gray-400 bg-transparent hover:bg-gray-500 hover:text-gray-200": variant === "outline-gray",
      "bg-transparent text-brand": variant === "link",
