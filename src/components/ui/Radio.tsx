...
export default function Radio({ disabled, communityStyles, className = "", ...props }: RadioProps) {
  ...
  const radioClassName = classNames("w-9 h-9 border-gray-400 text-brand rounded-full", { "cursor-not-allowed border-4": disabled }, { "cursor-pointer": !disabled }, className);
