 ...
 */
export default function Video({ url, ...props }: VideoProps): ReactElement | null
 {
if(!url) return null;

  return (
    <div data-testid="video" {...props} className="relative mt-7 lg:w-full lg:h-auto aspect-w-16 aspect-h-11 md:aspect-h-10 lg:aspect-h-9 md:w-full h-auto md:m-auto md:ml-auto">
