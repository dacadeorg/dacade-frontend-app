...
Feature branches should have one of the following prefixes: fix (bug fix), ft (feature), ht (hotfix), chore, test (testing) or doc (documentation), followed by a forward slash and a descriptive name.
